...
int Res_to_txt_5_var()
{
    ...
    in_file_res.open("/home/agarabag/millepede/target/algn_S1L0_iter4.res");
    in_file_input.open("/home/agarabag/condor_jobs/actual_align_mc_test/inputforalign.txt");
    temp_res_out.open("temporary_res.txt");
    temp_input_out.open("temporary_input.txt");
    out_file.open("S1L0_iter4.txt");
    if (!in_file_res){
