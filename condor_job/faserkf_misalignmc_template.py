...
CKF2GlobalAlignment, FaserActsExtrapolationTool, FaserActsTrackingGeometryTool=CompFactory.getComps("CKF2GlobalAlignment", "FaserActsExtrapolationTool","FaserActsTrackingGeometryTool")
...
def CKF2GlobalAlignment_OutputESDCfg(flags):
    acc = ComponentAccumulator()
...
def CKF2GlobalAlignmentCfg(flags, **kwargs):
    ...
    globalchi2fit = CompFactory.CKF2GlobalAlignment(**kwargs)
    ...
    histSvc.Output +=  [ "CKF2GlobalAlignment DATAFILE='kfalignment_mc_666NAME666.root' OPT='RECREATE'"]
...
#   acc.merge(FaserSCT_ClusterizationCfg(ConfigFlags, DataObjectName="SCT_xAODs", checkBadChannels=True))
   ...
   acc.merge(CKF2GlobalAlignmentCfg(ConfigFlags))
