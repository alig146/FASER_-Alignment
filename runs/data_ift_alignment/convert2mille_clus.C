...
void convert2mille_v2(){
  //data23
//  TFile* f1=new TFile("/afs/cern.ch/user/k/keli/eos/Faser/alignment/global/data23/kfalignment_data_iter4_noIFT_noZ.root");
//  Mille mille_file("/afs/cern.ch/user/k/keli/eos/Faser/alignment/global/data23/mp2input.bin");
  //data22
//  TFile* f1=new TFile("/afs/cern.ch/user/k/keli/eos/Faser/alignment/global/8023_8025_8115_8301_8730_9073/kfalignment_data_iter4_4sta.root");
//  Mille mille_file("/afs/cern.ch/user/k/keli/eos/Faser/alignment/global/8023_8025_8115_8301_8730_9073/mp2input.bin");
  ...
  TFile* f1=new TFile("/afs/cern.ch/user/k/keli/eos/Faser/alignment/global/misalign_MC/kfalignment_mc_iter-1_4sta.root");
