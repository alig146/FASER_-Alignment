...
//only for IFT
void convert2mille_v3(){
  TFile* f1=new TFile("/afs/cern.ch/user/k/keli/eos/Faser/alignment/global/8023_8025_8115_8301_8730_9073/kfalignment_data_iter1_IFT.root");
  //TFile* f1=new TFile("/afs/cern.ch/user/k/keli/eos/Faser/alignment/global/misalign_MC/test_shift_SP.root");
  ...
  bool dumpIFTstations=true;
  bool dump6ndf_IFTstations=true;
  ...
  std::vector<double>* m_align_ift_id=0;
  std::vector<double>* m_align_ift_local_measured_x=0;
  std::vector<double>* m_align_ift_local_measured_y=0;
  std::vector<double>* m_align_ift_local_fitted_x=0;
  std::vector<double>* m_align_ift_local_fitted_y=0;
  std::vector<double>* m_align_ift_local_residual_x=0;
  std::vector<double>* m_align_ift_local_residual_y=0;
  std::vector<double>* m_align_ift_global_measured_x=0;
  std::vector<double>* m_align_ift_global_measured_y=0;
  std::vector<double>* m_align_ift_global_measured_z=0;
  std::vector<double>* m_align_ift_global_fitted_x=0;
  std::vector<double>* m_align_ift_global_fitted_y=0;
  std::vector<double>* m_align_ift_global_fitted_z=0;
  std::vector<double>* m_align_ift_local_derivation_x_x=0;
  std::vector<double>* m_align_ift_local_derivation_x_y=0;
  std::vector<double>* m_align_ift_local_derivation_x_z=0;
  std::vector<double>* m_align_ift_local_derivation_x_rx=0;
  std::vector<double>* m_align_ift_local_derivation_x_ry=0;
  std::vector<double>* m_align_ift_local_derivation_x_rz=0;
  std::vector<double>* m_align_ift_local_derivation_y_x=0;
  std::vector<double>* m_align_ift_local_derivation_y_y=0;
  std::vector<double>* m_align_ift_local_derivation_y_z=0;
  std::vector<double>* m_align_ift_local_derivation_y_rx=0;
  std::vector<double>* m_align_ift_local_derivation_y_ry=0;
  std::vector<double>* m_align_ift_local_derivation_y_rz=0;
  std::vector<double>* m_align_ift_global_derivation_x_x=0;
  std::vector<double>* m_align_ift_global_derivation_x_y=0;
  std::vector<double>* m_align_ift_global_derivation_x_z=0;
  std::vector<double>* m_align_ift_global_derivation_x_rx=0;
  std::vector<double>* m_align_ift_global_derivation_x_ry=0;
  std::vector<double>* m_align_ift_global_derivation_x_rz=0;
  std::vector<double>* m_align_ift_global_derivation_y_x=0;
  std::vector<double>* m_align_ift_global_derivation_y_y=0;
  std::vector<double>* m_align_ift_global_derivation_y_z=0;
  std::vector<double>* m_align_ift_global_derivation_y_rx=0;
  std::vector<double>* m_align_ift_global_derivation_y_ry=0;
  std::vector<double>* m_align_ift_global_derivation_y_rz=0;
  std::vector<double>* m_align_ift_local_derivation_x_par_x=0;
  std::vector<double>* m_align_ift_local_derivation_x_par_y=0;
  std::vector<double>* m_align_ift_local_derivation_x_par_theta=0;
  std::vector<double>* m_align_ift_local_derivation_x_par_phi=0;
  std::vector<double>* m_align_ift_local_derivation_x_par_qop=0;
  std::vector<double>* m_align_ift_local_derivation_y_par_x=0;
  std::vector<double>* m_align_ift_local_derivation_y_par_y=0;
  std::vector<double>* m_align_ift_local_derivation_y_par_theta=0;
  std::vector<double>* m_align_ift_local_derivation_y_par_phi=0;
  std::vector<double>* m_align_ift_local_derivation_y_par_qop=0;
  ...
  t1->SetBranchAddress("fitParam_align_ift_id", &m_align_ift_id);
  t1->SetBranchAddress("fitParam_align_ift_local_measured_x", &m_align_ift_local_measured_x);
  t1->SetBranchAddress("fitParam_align_ift_local_measured_y", &m_align_ift_local_measured_y);
  t1->SetBranchAddress("fitParam_align_ift_local_fitted_x", &m_align_ift_local_fitted_x);
  t1->SetBranchAddress("fitParam_align_ift_local_fitted_y", &m_align_ift_local_fitted_y);
  t1->SetBranchAddress("fitParam_align_ift_local_residual_x", &m_align_ift_local_residual_x);
  t1->SetBranchAddress("fitParam_align_ift_local_residual_y", &m_align_ift_local_residual_y);
  t1->SetBranchAddress("fitParam_align_ift_global_measured_x", &m_align_ift_global_measured_x);
  t1->SetBranchAddress("fitParam_align_ift_global_measured_y", &m_align_ift_global_measured_y);
  t1->SetBranchAddress("fitParam_align_ift_global_measured_z", &m_align_ift_global_measured_z);
  t1->SetBranchAddress("fitParam_align_ift_global_fitted_x", &m_align_ift_global_fitted_x);
  t1->SetBranchAddress("fitParam_align_ift_global_fitted_y", &m_align_ift_global_fitted_y);
  t1->SetBranchAddress("fitParam_align_ift_global_fitted_z", &m_align_ift_global_fitted_z);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_x", &m_align_ift_local_derivation_x_x);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_y", &m_align_ift_local_derivation_x_y);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_z", &m_align_ift_local_derivation_x_z);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_rx", &m_align_ift_local_derivation_x_rx);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_ry", &m_align_ift_local_derivation_x_ry);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_rz", &m_align_ift_local_derivation_x_rz);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_x", &m_align_ift_local_derivation_y_x);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_y", &m_align_ift_local_derivation_y_y);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_z", &m_align_ift_local_derivation_y_z);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_rx", &m_align_ift_local_derivation_y_rx);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_ry", &m_align_ift_local_derivation_y_ry);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_rz", &m_align_ift_local_derivation_y_rz);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_x_x", &m_align_ift_global_derivation_x_x);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_x_y", &m_align_ift_global_derivation_x_y);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_x_z", &m_align_ift_global_derivation_x_z);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_x_rx", &m_align_ift_global_derivation_x_rx);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_x_ry", &m_align_ift_global_derivation_x_ry);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_x_rz", &m_align_ift_global_derivation_x_rz);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_y_x", &m_align_ift_global_derivation_y_x);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_y_y", &m_align_ift_global_derivation_y_y);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_y_z", &m_align_ift_global_derivation_y_z);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_y_rx", &m_align_ift_global_derivation_y_rx);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_y_ry", &m_align_ift_global_derivation_y_ry);
  t1->SetBranchAddress("fitParam_align_ift_global_derivation_y_rz", &m_align_ift_global_derivation_y_rz);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_par_x", &m_align_ift_local_derivation_x_par_x);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_par_y", &m_align_ift_local_derivation_x_par_y);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_par_theta", &m_align_ift_local_derivation_x_par_theta);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_par_phi", &m_align_ift_local_derivation_x_par_phi);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_x_par_qop", &m_align_ift_local_derivation_x_par_qop);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_par_x", &m_align_ift_local_derivation_y_par_x);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_par_y", &m_align_ift_local_derivation_y_par_y);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_par_theta", &m_align_ift_local_derivation_y_par_theta);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_par_phi", &m_align_ift_local_derivation_y_par_phi);
  t1->SetBranchAddress("fitParam_align_ift_local_derivation_y_par_qop", &m_align_ift_local_derivation_y_par_qop);
...
//std::cout<<"like "<<ievt<<" "<<m_fitParam_chi2/m_fitParam_ndf<<" "<<m_fitParam_pz<<" "<<m_fitParam_align_id->size()<<std::endl;
    if(m_fitParam_chi2>100||m_fitParam_pz<100||m_fitParam_pz>5000||m_fitParam_align_id->size()<15||fabs(m_fitParam_py/m_fitParam_pz)>0.001||fabs(m_fitParam_px/m_fitParam_pz)>0.01)continue;
    //only use the events with 3 SP at IFT
    if(m_align_ift_local_fitted_x->size()!=3)continue;
...
//      std::cout<<"like "<<ievt<<" "<<ihit<<" "<<loc_der.size()<<std::endl;
    ...
    //IFT, use spacepoint
    // convert x/y seperately
//    std::cout<<"like tot hit "<<m_align_ift_id->size()<<" "<<m_align_ift_local_fitted_x->size()<<std::endl;
    for(int ihit = 0; ihit<m_align_ift_local_fitted_x->size();++ihit){
      labels.clear();
      glo_der.clear();
      loc_der.clear();
      if(m_align_ift_local_fitted_x->at(ihit)<-9000)continue;
    if(fabs(m_align_ift_local_residual_y->at(ihit))>20||(m_align_ift_local_residual_x->at(ihit))>2||fabs(m_align_ift_local_derivation_x_par_theta->at(ihit))>9000.||fabs(m_align_ift_local_derivation_x_x->at(ihit))>9000.)continue;

      int moduleid = m_align_ift_id->at(ihit);
      if(moduleid%10==1)--moduleid;
      moduleid+=1000;//station from 1 not 0
      if(dump6ndf_modules){
	labels.push_back(moduleid*10+0+1);//millepede can not have label at 0
	...
	labels.push_back(moduleid*10+4+1);
	labels.push_back(moduleid*10+5+1);
	glo_der.push_back(m_align_ift_local_derivation_x_x->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_x_y->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_x_z->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_x_rx->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_x_ry->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_x_rz->at(ihit));
      }
      else{
	labels.push_back(moduleid*10+0+1);//millepede can not have label at 0
	labels.push_back(moduleid*10+1+1);
...
//	std::cout<<"id "<<moduleid<<" "<<layerid<<std::endl;
	if(dump6ndf_layers){
	  ...
	  labels.push_back(layerid*10+3+1);
	  labels.push_back(layerid*10+4+1);
	  glo_der.push_back(m_align_ift_global_derivation_x_x->at(ihit));
	  glo_der.push_back(m_align_ift_global_derivation_x_y->at(ihit));
	  if(dumpz_layers)
	  {
	    labels.push_back(layerid*10+5+1);
	    glo_der.push_back(m_align_ift_global_derivation_x_z->at(ihit));
	  }
	  glo_der.push_back(m_align_ift_global_derivation_x_rx->at(ihit));
	  glo_der.push_back(m_align_ift_global_derivation_x_ry->at(ihit));
	  glo_der.push_back(m_align_ift_global_derivation_x_rz->at(ihit));
	}
	else{
	  labels.push_back(layerid*10+0+1);//millepede can not have label at 0
	  labels.push_back(layerid*10+1+1);
	...
	if(dump6ndf_IFTstations){
      ...
      loc_der.push_back(m_align_ift_local_derivation_x_par_x->at(ihit));
      loc_der.push_back(m_align_ift_local_derivation_x_par_y->at(ihit));
      loc_der.push_back(m_align_ift_local_derivation_x_par_theta->at(ihit));
      loc_der.push_back(m_align_ift_local_derivation_x_par_phi->at(ihit));
      loc_der.push_back(m_align_ift_local_derivation_x_par_qop->at(ihit));
      float* lcder = loc_der.data();
      float* glder = glo_der.data();
      int* label = labels.data();
      resi=m_align_ift_local_residual_x->at(ihit);
      resi_e=0.02;
      //resi_e=m_fitParam_align_local_measured_xe->at(ihit);
      mille_file.mille(loc_der.size(), lcder, glo_der.size(), glder, label, resi, resi_e);
	...
	labels.push_back(moduleid*10+4+1);
	labels.push_back(moduleid*10+5+1);
	glo_der.push_back(m_align_ift_local_derivation_y_x->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_y_y->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_y_z->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_y_rx->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_y_ry->at(ihit));
	glo_der.push_back(m_align_ift_local_derivation_y_rz->at(ihit));
      }
      else{
	labels.push_back(moduleid*10+0+1);//millepede can not have label at 0
	labels.push_back(moduleid*10+1+1);
	...
	if(dump6ndf_layers){
	  ...
	  labels.push_back(layerid*10+3+1);
	  labels.push_back(layerid*10+4+1);
	  glo_der.push_back(m_align_ift_global_derivation_y_x->at(ihit));
	  glo_der.push_back(m_align_ift_global_derivation_y_y->at(ihit));
	  if(dumpz_layers)
	  {
	    labels.push_back(layerid*10+5+1);
	    glo_der.push_back(m_align_ift_global_derivation_y_z->at(ihit));
	  }
	  glo_der.push_back(m_align_ift_global_derivation_y_rx->at(ihit));
	  glo_der.push_back(m_align_ift_global_derivation_y_ry->at(ihit));
	  glo_der.push_back(m_align_ift_global_derivation_y_rz->at(ihit));
	}
	else{
	  labels.push_back(layerid*10+0+1);//millepede can not have label at 0
	  labels.push_back(layerid*10+1+1);
	...
	if(stationid!=1)continue;
	if(dump6ndf_IFTstations){
//	  std::cout<<stationid<<" "<<stationid*10+0+1<<std::endl;
	  labels.push_back(stationid*10+0+1);//millepede can not have label at 0
	  labels.push_back(stationid*10+1+1);
	  labels.push_back(stationid*10+2+1);
	  labels.push_back(stationid*10+3+1);
      ...
      loc_der.push_back(m_align_ift_local_derivation_y_par_x->at(ihit));
      loc_der.push_back(m_align_ift_local_derivation_y_par_y->at(ihit));
      loc_der.push_back(m_align_ift_local_derivation_y_par_theta->at(ihit));
      loc_der.push_back(m_align_ift_local_derivation_y_par_phi->at(ihit));
      loc_der.push_back(m_align_ift_local_derivation_y_par_qop->at(ihit));
      lcder = loc_der.data();
      glder = glo_der.data();
      resi=m_align_ift_local_residual_y->at(ihit);
      resi_e=0.8;
      mille_file.mille(loc_der.size(), lcder, glo_der.size(), glder, label, resi, resi_e);
    }
  mille_file.end();
