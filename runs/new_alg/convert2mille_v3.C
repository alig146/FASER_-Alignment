...
void convert2mille_v3(){
  ...
  Mille mille_file("/home/agarabag/millepede/ift_mc_align/test.bin");
  TFile* f1=new TFile("/data/agarabag/alignment_output/new_alg_ift_test_vk_ini2/kfalignment_mc.root");
